...
4. Add questions. Every valid question has exactly one correct answer and exactly nine non-empty, distinct incorrect answers. The editor visibly tracks the `9 / 9` requirement.
